...
tanggallengkap = namahari[hari] + ", " +tanggal + " " + namabulan[bulan] + " " + tahun;
    ...
    <!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
      ...
      <body class="skin-black">
		...
		<b>Selamat Datang di E-Perpustakaan (Perpustakaan Berbasis Website), Untuk Login Admin silahkan klik Icon User atau klik <a href="login.html">disini</a></b>
          </div>
            </div>
...
<!-- Data Total Pengunjung -->                        
              ...
              <!-- row end -->
                ...
                <div class="footer-main">
                    Copyright &copy <a href="http://www.sarjanakomedi.com" target="_blank">SDN 6 Bebandem</a> 2024
                </div>
            </aside><!-- /.right-side -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">E-Perpustakaan</h4>
      </div>
      <div class="modal-body">
      PerPusWeb adalah aplikasi perpustakaan bebasis website yang responsif. Untuk info, saran, maupun kritik bisa menghubungi
      developer:
      <table>
      <tr>
      <td>No Telepon</td> <td>:</td> <td>085337591021</td>
      </tr>
      <br />
      <tr>
      <td>E-mail</td><td>:</td> <td><a href="mailto:juniarti.uni12@gmail.com">juniarti.uni12@gmail.com</a> | <a href="mailto:kharismawulan8@gmail.com">kharismawulan8@gmail.com</a></td>
      </tr> 
       </table>
      </div>
